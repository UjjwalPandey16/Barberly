...
public class KeycloakUserService {
    ...
    private static final String CLIENT_SECRET = "aRWWJAXPCRU9H4heBbEBdu6rRe7nGI4N"; // Replace with your client secret
    private static final String GRANT_TYPE = "password";
    private static final String scope = "openid email profile"; // Adjust grant type if necessary
    private static final String username = "admin2@gmail.com";
    private static final String password = "admin2";
    private static  final String clientId = "7180b094-5b6b-4381-b938-6c8dcf55f147";
